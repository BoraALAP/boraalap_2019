...
export const projects = [
  ...
  },
  {
    ...
    description:
      "BonAPP is a native app which serves more than 20.000 people and it is for major corporations, universities, hospitals, and etc. It allows the user to access café and order meals ahead of time.",
    link: "BonAPP",
    projectAttributes: [
      "Native App",
      "UI / UX",
